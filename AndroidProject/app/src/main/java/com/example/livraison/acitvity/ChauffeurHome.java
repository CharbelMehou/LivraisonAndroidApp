...
public class ChauffeurHome extends AppCompatActivity {
    FirebaseAuth auth;
    Button logOutbutton;
    Button buttonSetData;
    Button gotoWaitingDelivery;
    Button gotoOngoingDelivery;
    Button gotoDeliveryHistory;
    TextView textView;
    FirebaseUser user;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chauffeur_home);
        ...
        gotoWaitingDelivery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        gotoDeliveryHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(getApplicationContext(),DeliveryHistory.class);
                startActivity(intent);
                finish();
            }
        });
